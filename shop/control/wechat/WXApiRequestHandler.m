...
{
    PayReq* req = [PayReq requestWithType:type openID:openID partnerId:partnerId prepayId:prepayId nonceStr:nonceStr timeStamp:timeStamp package:package sign:sign];
...
+ (BOOL)sendOpenID:(NSString*)openID
       ...
       timeStamp:(NSString *)timeStamp/** 时间戳，防重发 */
         package:(NSString *)package/** 商家根据财付通文档填写的数据和签名 */
            sign:(NSString *)sign/** 商家根据微信开放平台文档对数据做的签名 */
{
    PayReq* req = [PayReq requestWithOpenID:openID partnerId:partnerId prepayId:prepayId nonceStr:nonceStr timeStamp:timeStamp package:package sign:sign];
...
+ (BOOL)sendPartnerId:(NSString *)partnerId/** 商家向财付通申请的商家id */
       ...
       timeStamp:(NSString *)timeStamp/** 时间戳，防重发 */
         package:(NSString *)package/** 商家根据财付通文档填写的数据和签名 */
            sign:(NSString *)sign/** 商家根据微信开放平台文档对数据做的签名 */
{
    PayReq* req = [PayReq requestWithPartnerId:partnerId prepayId:prepayId nonceStr:nonceStr timeStamp:timeStamp package:package sign:sign];
...
{
    SendAuthReq* req = [SendAuthReq requestWithOpenID:openID scope:scope state:state];
    return [WXApi sendReq:req];
}
